...
% 18
\begin{frame}{Correctness and Visualization}
  \scriptsize
  \begin{itemize}
    \item Unit tests verify GA operators and local search.
    \item \texttt{validate\_tour.py} checks permutation validity and recomputes length.
    \item For $N \le 10$, brute force gives the exact optimum.
  \end{itemize}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{route.png}
      \centering Route visualization
    \end{column}
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{converge.png}
      \centering Convergence visualization
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Experiment 1: Runtime vs Input Size}
  \begin{figure}
    \centering
    \includegraphics[width=0.78\linewidth]{exp_size.png}
  \end{figure}
  \vspace{-0.3cm}
...
\begin{frame}{Experiment 2: Granularity}
  \begin{figure}
    \centering
    \includegraphics[width=0.82\linewidth]{exp_gran.png}
  \end{figure}
\end{frame}
...
\begin{frame}{Experiment 3: Speedup}
  \begin{figure}
    \centering
    \includegraphics[width=0.82\linewidth]{exp_speedup.png}
  \end{figure}
\end{frame}
